...
const events = [
  ...
  },
  {
    ...
    type: "In-person",
    description:
      "A comprehensive summit focusing on the latest trends and challenges in human resources.",
  },
  {
    ...
    type: "Remote",
    description:
      "An interactive workshop on the latest advancements in AI and machine learning.",
  },
  {
    ...
    type: "In-person",
    description:
      "Watch startups pitch their ideas to a panel of investors and industry experts.",
  },
  {
    ...
    type: "Remote",
    description:
      "Learn about the latest trends and best practices in cybersecurity from top experts.",
  },
  {
    ...
    type: "In-person",
    description:
      "A deep dive into the most effective marketing strategies for the upcoming year.",
  },
];
