  ...
  return (
    <section className="relative w-full py-8 overflow-hidden bg-gradient-to-br from-primary-medium to-primary-mirage text-semantic-white">
      ...
      <div className="relative z-10 container mx-auto px-6">
        ...
        <div className="h-[46rem] md:h-[36rem] lg:h-[36rem] rounded-md flex flex-col antialiased dark:bg-black dark:bg-grid-white/[0.05] items-center justify-center relative overflow-hidden">
          <InfiniteMovingCards
            items={testimonials}
            direction="right"
            speed="slow"
